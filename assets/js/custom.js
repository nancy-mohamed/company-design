		...
		jQuery(window).on('scroll', function () {
			if (jQuery('.sticky-header').length > 0) {
				...
				if ($(window).scrollTop() > menu.offset().top) {
					...
					$('.box_part .site-header .sticky-header').removeClass('is-fixed')
...
jQuery(document).ready(function () {
	...
	// $('.icon-bx-wraper.style-8:after').css('height', $('.icon-bx-wraper.style-8').height());
	/************************************************** */
});
// console.log($('.icon-bx-wraper.style-8').height());
/* Document.ready END */
...
$(document).ready(function () {
	...
	$('.css-trigger').click(function () {
		$('.style-switcher').toggleClass('active');
	})
	$("li a[data-theme]").click(function () {
